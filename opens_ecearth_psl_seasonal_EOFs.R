...
subset = list(lat = list(-40:0), lon = list(0:20,310:360))
...
fig <- grid.arrange(g1,g4,g2,g5,g3,g6, ncol = 2,top = textGrob(paste0(sel.season," , lead = ",sel.lead,": EOFs of SLP anomalies (without trend, weighted by cos(lat)) EC-Earth3"),gp=gpar(fontsize=13,font=3)))
ggsave(filename=paste0("/home/maralv/Dropbox/DMI/Figures/",sel.season,"lead",sel.lead,"_EOFs_SLPA_weighted_notrend.png"),plot=fig,width = 10, height = 8)
